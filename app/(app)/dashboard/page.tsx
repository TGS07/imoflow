...
export default async function DashboardPage() {
  ...
  const typeColors: Record<string, string> = { chamada: '#6B8DB5', visita: '#C4A05A', email: '#8B7DB5', reuniao: '#5A9E84', tarefa: '#C47070', nota: '#6B7280' }
  ...
  return (
    <div className="page-enter" style={{ padding: 'var(--space-6) var(--space-8)' }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 'var(--space-6)', gap: 12, flexWrap: 'wrap' }}>
        ...
        <Link href="/leads" className="btn btn-primary" style={{ flexShrink: 0, whiteSpace: 'nowrap' }}>
