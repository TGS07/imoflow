...
// Popup: lista de contactos A-Z, pesquisa por nome, checkbox por linha.
// Os contactos já presentes na pipeline aparecem marcados e desativados.
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" style={{ width: '100%', maxWidth: 420, maxHeight: '80vh', padding: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }} onClick={e => e.stopPropagation()}>
        <div style={{ padding: '18px 20px 12px', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
          ...
          <input className="input" placeholder="Pesquisar por nome…" value={search} onChange={e => setSearch(e.target.value)} autoFocus />
        </div>
